...
app.get(
	"https://back-end-trabalho-final.onrender.com/",
	(request, response) => {
...
app.get(
	"https://back-end-trabalho-final.onrender.com/list-users",
	(request, response) => {
		return response.json(listaUsuario);
	}
);
app.post(
	`https://back-end-trabalho-final.onrender.com/user`,
	(request, response) => {
		...
		const existe = listaUsuario.some(
...
//Logar no CRUD
app.post(
	`https://back-end-trabalho-final.onrender.com/login`,
	(request, response) => {
...
app.get(
	"https://back-end-trabalho-final.onrender.com/list-recados",
	(request, response) => {
...
app.post(
	`https://back-end-trabalho-final.onrender.com/recados`,
	(request, response) => {
		const dados = request.body;
...
//Atualizar recados
app.put(
	"https://back-end-trabalho-final.onrender.com/users/:id",
	(request, response) => {
...
// Deletar um recado
app.delete(
	`https://back-end-trabalho-final.onrender.com/recados/:id`,
	(request, response) => {
